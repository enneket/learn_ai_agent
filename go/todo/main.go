...
type TodoAddParams struct {
	Content  string `json:"content" jsonschema_description:"content of the todo"`
	StartAt  *int64 `json:"started_at,omitempty" jsonschema_description:"start time in unix timestamp"`
